      ...
      <div className={styles.inner}>
        <div className={styles.col}>
          <div className={styles.logoImgWrap}>
            <img src="/logo-footer.webp" alt="Travel Wings USA" className={styles.logoImg} />
          </div>
        ...
        <div className={styles.col}>
          ...
          <ul className={styles.links}>
            {[['/', 'Home'], ['/about', 'About Us'], ['/destinations', 'Destinations'], ['/blog', 'Blog'], ['/contact', 'Contact']].map(([href, label]) => (
              <li key={href}><a href={href} className={styles.footerLink}><ChevronRight size={12} /> {label}</a></li>
            ))}
          </ul>
        </div>
